...
- [x] link:https://github.com/hpalacio/leyes/pull/3[Protección de las personas con discapacidad] [![PR #3 status](https://img.shields.io/github/pulls/detail/state/hpalacio/leyes/3?label=PR-3)](https://github.com/hpalacio/leyes/pull/3)
- [ ] link:https://github.com/hpalacio/leyes/pull/4[Participación ciudadana en decisiones trascendentes] [![PR #4 status](https://img.shields.io/github/pulls/detail/state/hpalacio/leyes/4?label=PR-4)](https://github.com/hpalacio/leyes/pull/4)
- [ ] link:https://github.com/hpalacio/leyes/pull/5[Reintegración efectiva del Derecho Civil valenciano] [![PR #5 status](https://img.shields.io/github/pulls/detail/state/hpalacio/leyes/5?label=PR-5)](https://github.com/hpalacio/leyes/pull/5)
- [ ] link:https://github.com/hpalacio/leyes/pull/8[Senador propio para la isla de Formentera] [![PR #8 status](https://img.shields.io/github/pulls/detail/state/hpalacio/leyes/8?label=PR-8)](https://github.com/hpalacio/leyes/pull/8)
- [ ] link:https://github.com/hpalacio/leyes/pull/11[Garantizar el derecho al aborto] [![PR #11 status](https://img.shields.io/github/pulls/detail/state/hpalacio/leyes/11?label=PR-11)](https://github.com/hpalacio/leyes/pull/11)
