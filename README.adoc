...
Desde su promulgación en 1978, ya ha habido varias modificaciones de la C.E.; sin embargo, no resulta especiamente fácil ver las diferencias con respecto al texto original.
...
Actualmente, existen varias propuestas de reforma de la Consititución admitidas a trámite por las Cortes que se pueden consultar en la lista de link:https://github.com/hpalacio/leyes/pulls[_Pull requests_]:

* https://github.com/hpalacio/leyes/pull/3[Protección de las personas con discapacidad] image:https://img.shields.io/github/pulls/detail/state/hpalacio/leyes/3?label=PR-3[PR #3 status,link=https://github.com/hpalacio/leyes/pull/3]
* https://github.com/hpalacio/leyes/pull/4[Participación ciudadana en decisiones trascendentes] image:https://img.shields.io/github/pulls/detail/state/hpalacio/leyes/4?label=PR-4[PR #4 status,link=https://github.com/hpalacio/leyes/pull/4]
* https://github.com/hpalacio/leyes/pull/5[Reintegración efectiva del Derecho Civil valenciano] image:https://img.shields.io/github/pulls/detail/state/hpalacio/leyes/5?label=PR-5[PR #5 status,link=https://github.com/hpalacio/leyes/pull/5]
* https://github.com/hpalacio/leyes/pull/8[Senador propio para la isla de Formentera] image:https://img.shields.io/github/pulls/detail/state/hpalacio/leyes/8?label=PR-8[PR #8 status,link=https://github.com/hpalacio/leyes/pull/8]
* https://github.com/hpalacio/leyes/pull/11[Garantizar el derecho al aborto] image:https://img.shields.io/github/pulls/detail/state/hpalacio/leyes/11?label=PR-11[PR #11 status,link=https://github.com/hpalacio/leyes/pull/11]
